...
// ═══════════════════════════════════════════════════
//  GERAÇÃO DE PDF PROFISSIONAL (RESTAURADA E ATUALIZADA)
// ═══════════════════════════════════════════════════
function gerarPDF(){
  // ── Validação ──
  const reqFields = [
  ...
  const missing = reqFields.filter(fx=>{
  ...
  if(missing.length>0){
    reqFields.forEach(fx=>{
      const el=document.getElementById(fx.id);
      if(el) el.style.borderColor = el.value.trim() ? 'var(--border)' : 'var(--danger)';
    });
  ...
  // Texto adaptável da Sustentação para o Cliente
  ...
  if(S.type === 'CROSS' && pacotesCobrados === 0){
    lblSustentacao = `Sustentação & Licenciamento (Cota inicial Cross inclusa)`;
  }

  const infraRows = `
    <tr style="background:#fafbfc">
      <td style="color:#555;font-size:10px">${lblSustentacao}</td>
      <td style="text-align:right;color:#555;font-size:10px">—</td>
      <td style="text-align:right;color:#555;font-size:10px">${sustVal > 0 ? f(sustVal) : 'R$ 0,00'}<span style="font-size:9px">/mês</span></td>
    </tr>
  ...
  const parcelaTexto = parcelasAtuais === 1
    ? 'À vista — 7 dias após assinatura'
    : `${parcelasAtuais}× de ${f(implFinal/parcelasAtuais)} sem juros`;
...
<div class="pagina">
  <div class="pagina-header">
    ...
    <div class="ph-right">
      <strong>Proposta Comercial — Sewe BI</strong><br>
...
<div class="arte">
  ...
  <div class="arte-hl">
    ...
    <div class="arte-sub">Desde 2020, ajudamos distribuidores de todo o Brasil a transformar dados em crescimento real.</div>
  </div>
  <div class="arte-stats">
    <div class="arte-stat"><div class="arte-stat-n">+200</div><div class="arte-stat-l">Clientes ativos</div></div><div class="arte-div"></div>
    <div class="arte-stat"><div class="arte-stat-n">+3B</div><div class="arte-stat-l">em negócios/ano</div></div><div class="arte-div"></div>
    <div class="arte-stat"><div class="arte-stat-n">+500</div><div class="arte-stat-l">Cidades atendidas</div></div><div class="arte-div"></div>
    <div class="arte-stat"><div class="arte-stat-n">5 ★</div><div class="arte-stat-l">Google Reviews</div></div><div class="arte-div"></div>
