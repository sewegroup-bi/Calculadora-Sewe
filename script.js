// CONFIGURAÇÕES E DADOS ORIGINAIS
...
function setSuite(s) { 
  ...
  document.getElementById('projeto-card').style.display = (s === 'PROJETO' ? 'block' : 'none');
  renderTiers(); renderProds(); calc(); 
}
...
function calc() {
  ...
  // NOVA LÓGICA: Sustentação baseada em blocos de 50 usuários
  ...
  document.getElementById('gb-mrr').textContent = f(mrrF);
